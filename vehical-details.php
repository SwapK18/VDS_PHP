...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,message,Status) VALUES(:useremail,:vhid,:frmdate,:todt,:messg,:stats)";
$query = $dbh->prepare($sql);
$query->bindParam(':useremail',$useremail,PDO::PARAM_STR);
$query->bindParam(':vhid',$vhid,PDO::PARAM_STR);
$query->bindParam(':frmdate',$fromdate,PDO::PARAM_STR);
$query->bindParam(':todt',$todate,PDO::PARAM_STR);
$query->bindParam(':messg',$message,PDO::PARAM_STR);
$query->bindParam(':stats',$stus,PDO::PARAM_STR);
$query->execute();
...
$sql = "SELECT tblvehicles.*,tblbrands.*,  tblFuealType.* from tblvehicles join tblbrands on tblbrands.id=tblvehicles.FkVehBrandId join tblFuealType on tblFuealType.id=tblvehicles.FkFuelTypeId where tblvehicles.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>RS. <?php echo htmlentities($result->PricePerDay);?> </p>
        ...
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-cogs" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->typeName);?></h5>
              <p>Fuel Type</p>
            </li>
