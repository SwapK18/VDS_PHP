...
if (isset($_POST['alogin']))
{
    ...
    {
        echo "<script>alert('Login failed. Something went wrong');</script>";
    }
}
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									...
									<button class="btn btn-primary btn-block" name="alogin" type="submit">LOGIN</button>
